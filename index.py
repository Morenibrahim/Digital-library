...
def main():
    ...
    book1 = Book("Harry Potter and the Sorcerer's Stone", "J.K. Rowling", 1997, "mystery")
    book2 = Book("To Kill a Mockingbird", "Harper Lee", 1960, "action")
    book3 = Book("1984", "George Orwell", 1949, "history")
